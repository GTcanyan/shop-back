...
public interface OrderDao {
    ...
    @Select("SELECT o.*,od.shop_id,od.quantity,od.price,s.`name`,s.img,s.description FROM orders o LEFT JOIN order_details od ON od.order_id = o.order_id LEFT JOIN shop s ON s.ID = od.shop_id WHERE o.user_id=#{ userid }")
